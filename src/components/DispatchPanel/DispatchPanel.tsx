...
type Props = {
  ...
  onSave: (task: DispatchedTask, updatedRow: WorkRow) => void;
};
  ...
  return (
    <div className="dispatch-panel">
          ...
          visibleTasks.map((task, idx) => (
            ...
            >
              <div className="dispatch-card__top">
                ...
                <button
                  className="dispatch-card__edit-btn"
      ...
      {editingTask && (
        <TaskEditModal
          row={editingTask}
          title={editingTask.來源標籤}
          mode="edit"
          allTags={allTags}
          onSave={updatedRow => { onSave(editingTask, updatedRow); setEditingTask(null); }}
